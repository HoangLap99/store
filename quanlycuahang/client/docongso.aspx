<%@ Page Title="Đồ Công sở" Language="C#" MasterPageFile="~/marterpage/client.Master" AutoEventWireup="true" CodeBehind="docongso.aspx.cs" Inherits="quanlycuahang.client.docongso" %>
...
<br />
	     ...
	     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DataShopConnectionString %>" SelectCommand="SELECT [proID], [proName], [proPrice], [proDiscount], [proPhoto] FROM [Products] WHERE ([typeID] = @typeID)">
             <SelectParameters>
                 <asp:ControlParameter ControlID="DataList1" DefaultValue="4" Name="typeID" PropertyName="SelectedValue" Type="Int32" />
             </SelectParameters>
         </asp:SqlDataSource>
	 </div>
